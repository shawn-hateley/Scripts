...
if [ -d "/Volumes/Sensor-Network/Watershed_Pictures/test" ]; then
	webcamImageFolder="/Volumes/Sensor-Network/Watershed_Pictures/test"
...
hostname=`hostname`
if [ "${hostname}" == "Shawns-Mac-Pro.local" ]; then
...
find . -maxdepth 2 -type f -mmin +1 -name "*.JPG" > "${imageMoveList}"
