...
export declare function getEnumValues<E extends EnumType<E>>(group: E): E[keyof E][];
export declare function getEnumName<E extends EnumType<E>>(group: E, value: number, addNumberValue?: boolean, undefinedFallbackValue?: string): string | null;
...
export declare const DEFAULT_BACNET_PORT = 47808;
export declare enum ConfirmedServiceChoice {
    ACKNOWLEDGE_ALARM = 0,
...
export declare enum UnconfirmedServiceChoice {
    I_AM = 0,
    I_HAVE = 1,
...
export declare enum AccessAuthenticationFactorDisable {
    NONE = 0,
    DISABLED = 1,
    DISABLED_LOST = 2,
    DISABLED_STOLEN = 3,
...
export declare enum AccessCredentialDisable {
    NONE = 0,
    DISABLE = 1,
    DISABLE_MANUAL = 2,
    DISABLE_LOCKOUT = 3
}
export declare enum AccessCredentialDisableReason {
    DISABLED = 0,
...
export declare enum AccessEvent {
    NONE = 0,
    GRANTED = 1,
    MUSTER = 2,
    PASSBACK_DETECTED = 3,
...
export declare enum AccessPassbackMode {
    PASSBACK_OFF = 0,
    HARD_PASSBACK = 1,
    SOFT_PASSBACK = 2
}
export declare enum AccessUserType {
    ASSET = 0,
    GROUP = 1,
    PERSON = 2
}
export declare enum AccessZoneOccupancyState {
    NORMAL = 0,
    BELOW_LOWER_LIMIT = 1,
    AT_LOWER_LIMIT = 2,
    AT_UPPER_LIMIT = 3,
...
export declare enum AuthenticationFactorType {
    UNDEFINED = 0,
    ERROR = 1,
    CUSTOM = 2,
    SIMPLE_NUMBER16 = 3,
...
export declare enum AuthorizationExemption {
    PASSBACK = 0,
    OCCUPANCY_CHECK = 1,
    ACCESS_RIGHTS = 2,
    LOCKOUT = 3,
...
export declare enum AuthorizationMode {
    AUTHORIZE = 0,
    GRANT_ACTIVE = 1,
    DENY_ALL = 2,
...
export declare enum BinaryLightingPV {
    OFF = 0,
    ON = 1,
    WARN = 2,
    WARN_OFF = 3,
...
export declare enum DoorAlarmState {
    NORMAL = 0,
    ALARM = 1,
...
export declare enum DoorSecuredStatus {
    SECURED = 0,
    UNSECURED = 1,
    UNKNOWN = 2
}
...
export declare enum DoorValue {
    LOCK = 0,
    UNLOCK = 1,
    PULSE_UNLOCK = 2,
    EXTENDED_PULSE_UNLOCK = 3
}
export declare enum EngineeringUnits {
...
export declare enum EscalatorFault {
    CONTROLLER_FAULT = 0,
...
export declare enum EscalatorMode {
    UNKNOWN = 0,
    STOP = 1,
    UP = 2,
    DOWN = 3,
...
export declare enum EscalatorOperationDirection {
    UNKNOWN = 0,
    STOPPED = 1,
    UP_RATED_SPEED = 2,
    UP_REDUCED_SPEED = 3,
...
export declare enum FileAccessMethod {
    RECORD_ACCESS = 0,
    STREAM_ACCESS = 1
}
export declare enum IPMode {
    NORMAL = 0,
    FOREIGN = 1,
    BBMD = 2
}
export declare enum LifeSafetyMode {
    OFF = 0,
    ON = 1,
    TEST = 2,
    MANNED = 3,
...
export declare enum LifeSafetyOperation {
    NONE = 0,
    SILENCE = 1,
    SILENCE_AUDIBLE = 2,
    SILENCE_VISUAL = 3,
...
export declare enum LifeSafetyState {
    QUIET = 0,
    PRE_ALARM = 1,
    ALARM = 2,
    FAULT = 3,
...
export declare enum LiftCarDirection {
    UNKNOWN = 0,
    NONE = 1,
    STOPPED = 2,
    UP = 3,
...
export declare enum LiftCarDoorCommand {
    NONE = 0,
    OPEN = 1,
    CLOSE = 2
}
export declare enum LiftCarDriveStatus {
    UNKNOWN = 0,
    STATIONARY = 1,
    BRAKING = 2,
    ACCELERATE = 3,
...
export declare enum LiftCarMode {
    UNKNOWN = 0,
    NORMAL = 1,
    VIP = 2,
    HOMING = 3,
...
export declare enum LiftGroupMode {
    UNKNOWN = 0,
    NORMAL = 1,
    DOWN_PEAK = 2,
    TWO_WAY = 3,
...
export declare enum LightingInProgress {
    IDLE = 0,
    FADE_ACTIVE = 1,
    RAMP_ACTIVE = 2,
    NOT_CONTROLLED = 3,
...
export declare enum LightingOperation {
    NONE = 0,
    FADE_TO = 1,
    RAMP_TO = 2,
    STEP_UP = 3,
...
export declare enum LightingTransition {
    NONE = 0,
    FADE = 1,
    RAMP = 2
}
...
export declare enum Maintenance {
    NONE = 0,
    PERIODIC_TEST = 1,
    NEED_SERVICE_OPERATIONAL = 2,
    NEED_SERVICE_INOPERATIVE = 3
}
export declare enum NetworkNumberQuality {
    UNKNOWN = 0,
    LEARNED = 1,
    LEARNED_CONFIGURED = 2,
    CONFIGURED = 3
}
export declare enum NetworkPortCommand {
    IDLE = 0,
    DISCARD_CHANGES = 1,
...
export declare enum ProgramRequest {
    READY = 0,
    LOAD = 1,
    RUN = 2,
    HALT = 3,
...
export declare enum PropertyIdentifier {
    ABSENTEE_LIMIT = 244,
    ACCEPTED_MODES = 175,
...
export declare enum ProtocolLevel {
    PHYSICAL = 0,
    PROTOCOL = 1,
...
export declare enum ShedState {
    SHED_INACTIVE = 0,
    SHED_REQUEST_PENDING = 1,
    SHED_COMPLIANT = 2,
    SHED_NON_COMPLIANT = 3
}
export declare enum SilencedState {
    UNSILENCED = 0,
    AUDIBLE_SILENCED = 1,
    VISIBLE_SILENCED = 2,
    ALL_SILENCED = 3
...
export declare enum TimerTransition {
    NONE = 0,
    IDLE_TO_RUNNING = 1,
    RUNNING_TO_IDLE = 2,
...
export declare enum EventTransitionBits {
    TO_OFFNORMAL = 0,
    TO_FAULT = 1,
    TO_NORMAL = 2
}
export declare enum LimitEnable {
    LOW_LIMIT_ENABLE = 0,
    HIGH_LIMIT_ENABLE = 1
}
...
export declare enum ObjectTypesSupported {
    ANALOG_INPUT = 0,
    ANALOG_OUTPUT = 1,
    ANALOG_VALUE = 2,
    BINARY_INPUT = 3,
...
export declare enum ResultFlags {
    FIRST_ITEM = 0,
    LAST_ITEM = 1,
    MORE_ITEMS = 2
}
export declare enum ServicesSupported {
    ACKNOWLEDGE_ALARM = 0,
    CONFIRMED_COV_NOTIFICATION = 1,
    CONFIRMED_EVENT_NOTIFICATION = 2,
    GET_ALARM_SUMMARY = 3,
...
export declare enum StatusFlags {
    IN_ALARM = 0,
    FAULT = 1,
    OVERRIDDEN = 2,
    OUT_OF_SERVICE = 3
...
export declare enum BvlcResultFormat {
...
export declare enum BvlcResultPurpose {
    BVLC_RESULT = 0,
...
export declare enum CharacterStringEncoding {
    UTF_8 = 0,
    MICROSOFT_DBCS = 1,
    JIS_X_0208 = 2,
    UCS_4 = 3,
...
export declare enum CovType {
    REAL = 0,
    BIT_STRING = 1
}
export declare enum EnableDisable {
    ENABLE = 0,
    DISABLE = 1,
    DISABLE_INITIATION = 2
}
export declare enum MaxApduLengthAccepted {
    OCTETS_50 = 0,
    OCTETS_128 = 1,
    OCTETS_206 = 2,
    OCTETS_480 = 3,
...
export declare enum MaxSegmentsAccepted {
    SEGMENTS_0 = 0,
    SEGMENTS_2 = 16,
    SEGMENTS_4 = 32,
    SEGMENTS_8 = 48,
...
export declare enum NetworkLayerMessageType {
...
export declare enum NpduControlBit {
    EXPECTING_REPLY = 4,
    SOURCE_SPECIFIED = 8,
    DESTINATION_SPECIFIED = 32,
    NETWORK_LAYER_MESSAGE = 128
}
export declare enum NpduControlPriority {
    NORMAL_MESSAGE = 0,
    URGENT_MESSAGE = 1,
    CRITICAL_EQUIPMENT_MESSAGE = 2,
    LIFE_SAFETY_MESSAGE = 3
}
export declare enum PduConReqBit {
    SEGMENTED_RESPONSE_ACCEPTED = 2,
    MORE_FOLLOWS = 4,
    SEGMENTED_MESSAGE = 8
}
export declare enum PduSegAckBit {
    SERVER = 1,
    NEGATIVE_ACK = 2
}
...
export declare enum PropertyStates {
    BOOLEAN_VALUE = 0,
    BINARY_VALUE = 1,
    EVENT_TYPE = 2,
    POLARITY = 3,
...
export declare enum ReadRangeType {
    BY_POSITION = 0,
    BY_SEQUENCE_NUMBER = 1,
    BY_TIME_REFERENCE_TIME_COUNT = 2
}
export declare enum ReinitializedState {
    COLDSTART = 0,
    WARMSTART = 1,
    STARTBACKUP = 2,
    ENDBACKUP = 3,
